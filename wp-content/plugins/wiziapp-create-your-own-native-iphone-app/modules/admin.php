		...
		function update_settings()
		{
			...
			switch ($_POST['name'])
			{
				...
				case 'android_app':
					...
					$apk_url = add_query_arg( 'SiteUrl', home_url(), $wiziapp_plugin_config['build_host'] . '/getapk' );
		...
		$this->_renderOptionsBox( array(
			...
			'items' => array(
				...
				array(
					'id' => 'ios_active',
					'type' => 'switch',
					'label' => __( 'Activate Wiziapp powered Themes - iPhone Native App', 'wiziapp-plugin' ),
					'description' => __( 'Deactivate to display your theme', 'wiziapp-plugin' ),
			...
			<div class="wiziapp-plugin-admin-state-buy-billing">
				...
				<div class="wiziapp-plugin-admin-settings-container">
					...
					<div class="wiziapp-plugin-admin-state-buy-billing-simulate wiziapp-plugin-admin-settings-button wiziapp-plugin-admin-state-buy-billing-simulate-device">
						<a href="https://play.google.com/store/apps/details?id=com.wiziapp.app_5d172be7ce2a43958cd8183cbbb1acf9" target="_blank" title="<?php _e('Native Android App', 'wiziapp-plugin') ?>"><?php _e('Simulate the App - Android Device', 'wiziapp-plugin') ?><span></span></a>
					</div>
				</div>
